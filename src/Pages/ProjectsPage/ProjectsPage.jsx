...
export default function ProjectsPage({ english, changeLanguage }) {
  ...
  useEffect(() => {
    ...
    experience.navigation.on('notProjectPage', () => {
      setShowContent(false)
    })

    return () => experience.navigation.off('notProjectPage', () => { })
  }, [])
        ...
        <section className={activeCategory === 0 ? 'project-menu huge' : 'project-menu'}>
          ...
          {activeCategory === 1 ? <Category1 english={english} onChange={changeActiveProject} />
            : activeCategory === 2 ? <Category2 english={english} onChange={changeActiveProject} />
              : activeCategory === 3 ? <Category3 english={english} onChange={changeActiveProject} />
                : null}
        </section>
